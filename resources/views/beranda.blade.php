    ...
    <div class="beranda" id="beranda">
        <div class="daftar">
            ...
            <div class="text-beranda bg-succss d-flex justify-content-center">
                <div class="text-center">
                    <h1 style="font-weight: bold">PPDB TP 2023-2024 <br> SMK Wikrama bogor</h1>
                    <p>Ayo! Segera daftarkan dirimu ke SMK Wikrama Bogor dengan cara <br> klik <b>Pendaftaran PPDB</b>
                        di
                        bawah ini!
                    </p>
                    <form action="{{ route('daftar') }}" method="">
                        <button class="daftar-btn">Pendaftaran PPDB</button>
                    </form>
                </div>
            </div>
            <div class="bg-wave">
        ...
        <div class="tentang-kami d-flex align-items-center" id="tentang-kami">
            ...
            <div class="layout4">
                ...
                <div class="item">
                    <iframe width="100%" height="100%" class="" src="https://www.youtube.com/embed/_V8ZWxAcGY4"
                        title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
                </div>
                <div class="item">
                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/_KYS5MT48tM"
                        title="YouTube video player" frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                        allowfullscreen></iframe>
                </div>
                    ...
                    <div class="footer-content-column">
                        <div class="footer-logo">
                            <a class="footer-logo-link" href="#">
                                <span class="hidden-link-text">SMK Wikrama Bogor</span>
                    ...
                    <div class="footer-content-column">
                        <div class="footer-menu">
                            ...
                            <ul id="menu-quick-links" class="footer-menu-list">
                                <li id="menu-item-168092"
                                    class="menu-item menu-item-type-custom menu-item-object-custom menu-item-168092">
                                    <a rel="noopener noreferrer" href="#beranda">Beranda</a>
                                </li>
                                <li id="menu-item-167418"
                                    class="menu-item menu-item-type-custom menu-item-object-custom menu-item-167418">
                                    <a rel="noopener noreferrer" href="#jurusan">Jurusan</a>
                                </li>
                                <li id="menu-item-167954"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-167954">
                                    <a href="#tentang-kami">Tentang Kami</a>
                                </li>
                                <li id="menu-item-167423"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-167423">
                                    <a href="#testimoni">Testimoni</a>
                                </li>
                                <li id="menu-item-167955"
                                    class="menu-item menu-item-type-post_type_archive menu-item-object-customer menu-item-167955">
                                    <a href="#hubungi-kami">Hubungi Kami</a>
                                </li>
                                <li id="menu-item-170700"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-170700">
                    ...
                    <div class="footer-content-column">
                        ...
                        <div class="footer-call-to-action">
                            ...
                            <p class="footer-call-to-action-link-wrapper"> <a class="footer-call-to-action-link"
                                    href="tel:0251-8242411" target="_self">0251-8242411 </a></p>
                        </div>
                    </div>
                ...
                <div class="footer-copyright">
                    <div class="footer-copyright-wrapper">
                        <p class="footer-copyright-text">
                            <a class="footer-copyright-link" href="#" target="_self"> ©2021-22. | PPDB SMK WIKRAMA BOGOR
                                | All
                                rights reserved. </a>
                        </p>
                    </div>

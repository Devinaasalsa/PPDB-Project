                ...
                <table class="table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('bukti', $student->user_id) }}">Lihat</a>
                            </td>
                            <td> <a href="{{ route('detail.pendaftaran', $student->user_id) }}">Detail</a>
                            </td>
                            <td>
                                @if($student['status'] == 1)
                                ...
                                <div class="d-flex gap-2">
                                    <form action="{{ route('validasi', $student->user_id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                        <button type="submit" class="btn btn-primary mr-3" style="color: white;">
                                            Validasi </button>
                                    </form>
                                    <form action="{{ route('tolak', $student->user_id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
                                    ...
                                    <div class="kartu-pembayaran">
                                        <div class="card-body p-0 mt-3">
                                            <div class="row align-items-start">
                                                <div class="col-sm-4">
                                                    ...
                                                    <select id="bank" name="nama_bank"
                                                        class="select2 form-control w-100 ml-0"
                                                        onchange='checkvalue(this.value)'>
                                                        <option hidden disabled selected style="padding:20px">--Pilih
                                                            Bank--</option>
                                                        <option value="PT BANK RAKYAT INDONESIA">PT BANK RAKYAT
                                                            INDONESIA</option>
                                                        <option value="PT BANK MANDIRI">PT BANK MANDIRI</option>
                                                        <option value="JP MORGAN CHASE BANK, NA">JP MORGAN CHASE BANK,
                                                            NA</option>
                                                        <option value="BANK OF AMERICA, N.A">BANK OF AMERICA, N.A
                                                        </option>
                                                        ...
                                                        <option value="BANK OF CHINA (HONG KONG) LIMITED">BANK OF CHINA
                                                            (HONG KONG)
                                                            LIMITED</option>
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <input type="file" name="img_bukti" class="form-control"
                                                    id="image_upload">
                                            </div>
                                            <br>
                                            <br>
...
<div class="card-content">
    <div class="card-body">
        <form class="form form-vertical" method="POST" action="{{ route('pembayaran.update') }}"
